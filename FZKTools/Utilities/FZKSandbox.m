...
+ (NSString *)sandboxFilePathWithFileName:(NSString *)fileName pathType:(SandboxType)type {
    NSString *path = nil;
    switch (type) {
        case SandboxTypeDocument: path = [self documentPath]; break;
        case SandboxTypeLibrary: path = [self libraryPath]; break;
        case SandboxTypeCache: path = [self cachePath]; break;
